...
class NotiRegisterPage extends StatefulWidget {
  const NotiRegisterPage({ Key? key }) : super(key: key);

  @override
  State<NotiRegisterPage> createState() => _NotiRegisterPageState();
}

class _NotiRegisterPageState extends State<NotiRegisterPage> {
   ReserveModel? detail;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('ແຈ້ງເຕືອນ'),),
