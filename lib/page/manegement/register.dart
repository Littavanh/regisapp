...
class RegisterCovidPage extends StatefulWidget {
  const RegisterCovidPage({ Key? key }) : super(key: key);

  @override
  State<RegisterCovidPage> createState() => _RegisterCovidPageState();
}
 final reserveDateController = TextEditingController(text: '');
int provinceId = 0,vaccineId=0,vacsiteId=0;
String date = DateTime.now().toString();
String level="1";
class _RegisterCovidPageState extends State<RegisterCovidPage> {
  @override
